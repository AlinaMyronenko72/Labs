    ...
    class Program
    {
        static void Main(string[] args)
        {
         ...
         // Serialization.DeserializationContainer(a, "D:/Учеба/laba11/file.bin");
          Serialization.SerializationContainer(a, "D:/Учеба/laba11.1/file1.bin");
         // Serialization.DeserializationContainer(a, "D:/Учеба/laba11.1/file1.bin");


            foreach (var v in a)
                    Console.WriteLine(v.ToString());
            WriteToFile.Write(a, "D:/Учеба/laba11.1/file2.txt");
